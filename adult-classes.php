                ...
                <div class="col-sm-12">
                    <div class="schedule-box" id="adult">
                        ...
                        foreach ($characters['feed']['entry'] as $item) {
                            if ($item['gsx$classtitle']['$t'] != "" && $item['gsx$classtext']['$t'] != "") {
...
<section id="heal-code">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <healcode-widget data-type="class_lists" data-widget-partner="object" data-widget-id="82167987567" data-widget-version="0.1"></healcode-widget>
            </div>
        </div>
    </div>
</section>
